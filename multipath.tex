...
Based on some graph properties we newly find, we propose IAC, which can
compute the full set of alternates based on incremental shortest path computation on a dual graph with specific link cost modification.
...
and finds about 50\% more available alternates in typical real-world topologies, but also
