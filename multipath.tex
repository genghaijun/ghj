...
generally deploy a technique called Loop Free Alternates for local fast rerouting. 
To handle link or node failures, alternate next hops are stored alongside with 
the default next hops in a router's forwarding table, and can be immediately activated 
to invoke a loop free repair path.
