...
Then we search the potential lower costs of $D_c(m)$'s neighbors, and insert them into $Q$
if the cost from the root $c$ can be reduced (line 14 $\sim$ 17) to allow further EXTRACTMIN operation.
