...
\begin{algorithm}[htb]\label{IACalg}
...
Algorithm 1 presents the pseudo code of IAC, where $C_{c}(*)$ and $D_{c}(*)$ denote 
the lowest cost from $c$ to a given node and the descent
represent variables with respect to the SPT $T_{c}$ (the superscript $G$ is omitted), 
