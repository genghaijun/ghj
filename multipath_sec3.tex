...
$c.visited=true$\;
 ...
 $L(c,x)\leftarrow 0$;\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad
%\begin{shaded}
(\textbf{In IAC-NA $L(c,x)=-L(c,x)$)}\;
%\end{shaded}
...
(\textbf {In IAC-NA Compute $C_x(v)$ using Theorem \ref{computeneighborcost}})\;
