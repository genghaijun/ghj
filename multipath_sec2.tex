...
A comparison of several existing solutions and our's can be
...
As shown in table \ref{britetable1}, only IAC can be applied to three LFA rules and can compute all the next hops  that meet the LFA rule. The other two algorithms do not support NPC rule.
...
average, LFA offers protection against only about 70\%
of all possible link failures and less than 60\% of node failures
