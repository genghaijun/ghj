...
\end{table}
\fi
\subsection{Protection ratio and the average number of backup next hops}
...
the cumulative distribution of the average  number of backup next hops for Abilene and CERNET2.
\begin{figure}[t]
\centering
...
\caption{Cumulative distribution distribution of the average number of next hops on TORONTO topology}
\label{cercumulative}
\end{figure}
