...
\begin{figure*}[t!]
        ...
        \end{subfigure}
         \begin{subfigure}[b]{0.32\textwidth}
                ...
                \caption{Measured and real networks}
                \label{realtopologytime}
        \end{subfigure}
        \caption{Computation overhead results on different topologies}
        \label{comoverhead}
\end{figure*}
...
\begin{figure*}[t!]
        ...
        \end{subfigure}
         \begin{subfigure}[b]{0.32\textwidth}
                ...
                \label{prreal}
        \end{subfigure}
        \caption{Protection ratio results on different topologies}
...
\begin{figure*}[t!]
        ...
        \end{subfigure}
         \begin{subfigure}[b]{0.32\textwidth}
                ...
                \label{realnumber}
        \end{subfigure}
        \caption{The average number of backup next hops on different topologies}
        \label{theoremexample}
\end{figure*}
\begin{figure*}[t!]
        \centering
